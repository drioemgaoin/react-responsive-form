...
export default class ResponsiveForm extends React.Component {
    ...
    onSubmitWithExternalValidation(values) {
        this.setState({ messages: {
            firstname: 'First Name external exception',
            quantity: 'Quantity external exception',
            email: 'Email external exception',
            gender: 'Gender external exception',
            note: 'Note external exception',
            time: 'Time external exception',
            service: 'Service external exception'
        }})
    }
    ...
    render() {
        return (
            <div>
                ...
                <h2>Custom Form validation style on submit</h2>
                ...
                <h2>Form external validation on submit</h2>
                <Form mode={FormMode.Edit} onFormSubmit={this.onSubmitWithExternalValidation.bind(this)} messages={this.state.messages}>
                    <Input ref={(el) => this.firstname = el}
                        name='firstname'
                        label='First Name'
                        placeholder='First Name' />
